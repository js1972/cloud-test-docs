...
public class SetupCMISRepository extends HttpServlet {
  private static final long serialVersionUID = 1L;

  public SetupCMISRepository() {
    super();
  }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      String uniqueName = "p1081110_TestCMISRepository";
      // Use a secret key only known to your application (min. 10 chars)
      String secretKey = "secretkey1234567890";
